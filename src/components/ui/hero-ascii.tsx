...
export default function HeroAscii() {
  ...
  useEffect(() => {
    setBarHeights(Array.from({ length: 8 }).map(() => Math.random() * 12 + 4));
  ...
  const handleJoinWaitlist = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLScoWBMosMPuGeQe5M5TNPslvtnhMKmJBty2Bbu9QPS1GZ8uIg/viewform?usp=publish-editor', '_blank');
  };
        ...
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            <div className="flex items-center gap-2">
              <Image src="/Explorion.png" alt="Explorion Logo" width={32} height={32} className="object-contain" />
        ...
        <div className="container mx-auto px-6 lg:px-16 lg:ml-[10%]">
          <div className="max-w-lg relative">
            ...
            <div className="relative">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-3 lg:mb-4 leading-tight font-mono tracking-wider" style={{ letterSpacing: '0.1em' }}>
                EXPLORION
                <span className="block text-white mt-1 lg:mt-2 opacity-90 text-2xl lg:text-3xl">
            ...
            <div className="relative">
              <p className="text-sm lg:text-lg text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Transforms complex knowledge into simple, structured, and easy-to-understand explanations. Powered by Solana.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <button onClick={handleJoinWaitlist} className="relative px-5 lg:px-6 py-3 lg:py-3.5 bg-white text-black font-mono text-sm lg:text-base font-bold border border-white hover:bg-transparent hover:text-white transition-all duration-200 group">
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">WAITLIST.OPEN</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <div className="hidden lg:flex gap-1">
              {barHeights.length > 0 ? barHeights.map((height, i) => (
                ...
                <div key={i} className="w-1 h-3 bg-white/30"></div>
              ))}
            </div>
            <span>V1.0.0</span>
          </div>
